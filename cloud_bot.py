...
KEYWORDS = [
    # 1. 기관 인사 및 동향 (사임, 취임, 전보 포함)
    "대구경찰청 인사", "경북경찰청 인사", "대구지검 인사", "대구지검 전보",
    "대구경찰청장", "경북경찰청장", "대구지검장", "대구지방국세청장",
    "대구 세무서", "경북 세무서",

    # 2. 기업 재난 / 사고 (세부 지역명 + 핵심 사고 단어 조합)
    "대구 공장 화재", "경북 공장 화재", "성서산단 화재", "구미산단 화재", "포항 철강공단",
    "대구 중대재해", "경북 중대재해", "대구 노동자 사망", "경북 노동자 사망",
    "대구 끼임 사고", "경북 추락 사고", "대구 화학물질 누출", "구미 불산 누출",

    # 3. 기업 이슈 / 수사 (세부 지역명 + 비리 단어 조합)
    "대구 압수수색", "경북 압수수색", "대구 횡령", "경북 횡령", "대구 배임", "경북 배임",
    "대구 업체 비리", "경북 업체 비리", "대구 세금 탈루", "경북 세무조사", 
    "구미 업체 구속", "포항 업체 압수수색",

    # 4. VIP 핵심 관리 기업 (이름만 들어가면 무조건 수집 후 AI가 검증)
